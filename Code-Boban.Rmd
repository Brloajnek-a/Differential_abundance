...
count_file <- "C:/Users/blank/OneDrive - mefst.hr/My documents/Publications and projects/BCG Boban/R/table.tsv"
sample_file <- "C:/Users/blank/OneDrive - mefst.hr/My documents/Publications and projects/BCG Boban/R/metadata_alphabet.txt"
...
tax <- read_qza("C:/Users/blank/OneDrive - mefst.hr/My documents/Publications and projects/BCG Boban/R/filtered-taxonomy.qza")    # Taxonomy table (to rowData)
...
There are no significant results in timepoint `r levels(as.factor(colData(tse1)$timeline))` or 6 using Aldex2.
...
```{r maaslin, output.lines=c(23,48)}
...
```{r ancom-bc-plots, fig.width = 15, fig.height=100}
# T1
...
```{r comparison-of-timepoints, fig.width = 15, fig.height=100}
